...
if __name__ == '__main__':
    ...
    test_image_path = os.getcwd() + "/test_data/"
    test_results_path = os.getcwd() + "/test_results/"

    test_image_root = test_image_path + "test_image_"

    # Read the number of *.jpg files in test_image_root
    jpg_files = glob.glob(test_image_path + "*.jpg")
